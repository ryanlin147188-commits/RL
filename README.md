...
從 [GitHub Releases](https://github.com/ryanlin147188-commits/RL_Auto_TMP/releases) 下載 `autotest-images-1.0.0.tar`(離線散佈包,含 backend / celery / runner / frontend 4 個 image),在你的 VM 上:
...
git clone https://github.com/ryanlin147188-commits/RL_Auto_TMP.git && cd RL_Auto_TMP
