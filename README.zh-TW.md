...
| 文件 | 說明 |
|---|---|
| [README.md](README.md) | 平台介紹、快速開始、功能一覽、技術架構、安全強化、FAQ |
| [操作說明.md](操作說明.md) | 完整使用者操作手冊（10 章節） |
| [SECURITY.md](SECURITY.md) | 安全漏洞回報政策、v1.1.5 OIDC 強化、自架部署安全建議 |
...
| 文件 | 說明 |
|---|---|
| [docs/ops/bootstrap.md](docs/ops/bootstrap.md) | 首次部署操作手冊（預設帳號、Zoho SSO、忘記密碼恢復） |
